...
ush_vptr_t ush_comm_howareyou_msg_ack(ush_comm_howareyou_msg_t msg);

ush_s32_t  ush_comm_howareyou_msg_remote_idx(ush_comm_howareyou_msg_t msg);

ush_s32_t  ush_comm_howareyou_msg_cert(ush_comm_howareyou_msg_t msg);

ush_size_t ush_comm_howareyou_msg_size();
